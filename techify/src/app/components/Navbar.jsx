  ...
  return (
    <div className="bg-[#e1eaff] px-5 md:px-14 xl:px-32 py-4 md:py-5 relative">
      <div className="flex items-center justify-between">
        ...
        <div className="lg:hidden">
          <button onClick={() => setMenuOpen(!menuOpen)} className="text-white p-3 rounded-md bg-[#684df4] text-2xl">
            <FiMenu />
          </button>
        </div>
      </div>
    ...
    >
      ...
      <ul className="mt-20 space-y-4 px-5 font-semibold text-[#141d38]">
        ...
        <li className="flex flex-col border-b border-pink-200 pb-3">
          <div className="flex items-center justify-between">
            ...
            >
              {openMenu === 'services' ? <BsDash /> : <BsPlus />}
            </button>
          </div>
          {openMenu === 'services' && (
            <ul className="mt-2 space-y-2 pl-8 transition-transform ease-in-out duration-700">
              <li className='border-y border-pink-200 py-3'>
                <Link href="/services/web-development" >Web Development</Link>
              </li>
              <li className='border-b border-pink-200 pb-3'>
        ...
        <li className="flex flex-col border-b border-pink-200 pb-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xl bg-gray-100 rounded-full"
            >
              {openMenu === 'blog' ? <BsDash /> : <BsPlus />}
            </button>
          </div>
          {openMenu === 'blog' && (
            <ul className="mt-2 space-y-2 pl-8 transition-all duration-300">
              <li className='border-y border-pink-200 py-3'>
